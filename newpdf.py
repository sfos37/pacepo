...
def main(date, horaire, cours, prof, datefich, dateweek):
    H1 = horaire[0][0]
    H2 = horaire[1][0]
    M1 = horaire[0][1]
    M2 = horaire[1][1]
    ...
    filename = '/home/mchouteau/Feuille-temps/%s.pdf' % week_num
    reference_pdf = PdfFileReader(open("/etc/pacepo/2021-2022_FichePrésence_CYBER2024.pdf", "rb"))
    ...
    if os.path.isfile(filename):
        ...
        outputStream = open("/home/mchouteau/Feuille-temps/temp.pdf", 'wb')
        output.write(outputStream)
        outputStream.close()
        merger.append(existing_pdf)
        merger.append("/home/mchouteau/Feuille-temps/temp.pdf")
